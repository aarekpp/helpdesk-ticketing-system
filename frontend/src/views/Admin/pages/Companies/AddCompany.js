...
export default function AddCompany() {
  ...
  const [formValidation, setFormValidation] = useState({
    companyName: { isValid: true, errorMessage: "", touched: false },
    cityName: { isValid: true, errorMessage: "", touched: false },
    address: { isValid: true, errorMessage: "", touched: false },
    zipCode: { isValid: true, errorMessage: "", touched: false },
  });
